...
void checkDepositValues(std::string file, double eps) {
...
TEST(DepositSuite, RegularValues) { /* Examples from calcus.ru */
  s21::checkDepositValues("tests/deposit_test.txt", DECIMAL_EPS);
}

TEST(DepositSuite, HugeValues) { /* Examples from calcus.ru */
  s21::checkDepositValues("tests/deposit_test_hard.txt", DECIMAL_LOOSE_EPS);
}
